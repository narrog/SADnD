        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (existingUserName != null) {
                    ModelState.AddModelError("Input.UserName", "Der Benutzername ist bereits vergeben.");
                    return Page();
                }
                ...
                if (existingEmail != null) {
                    ModelState.AddModelError("Input.Email", "Die E-Mail-Adresse ist bereits registriert.");
                    return Page();
                }
