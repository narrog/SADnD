    ...
    public partial class AddedAppointments : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentVotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppointmentVotes_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentVotes_AppointmentId",
                table: "AppointmentVotes",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentVotes_UserId",
                table: "AppointmentVotes",
                column: "UserId");
        }
