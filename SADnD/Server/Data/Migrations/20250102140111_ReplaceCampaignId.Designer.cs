...
namespace SADnD.Server.Migrations
{
    ...
    [Migration("20250102140111_ReplaceCampaignId")]
    partial class ReplaceCampaignId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserCampaign", b =>
                {
                    b.Property<int>("DungeonMasterCampaignsId")
                        .HasColumnType("integer");

                    b.Property<string>("EFDungeonMastersId")
                        .HasColumnType("text");

                    b.HasKey("DungeonMasterCampaignsId", "EFDungeonMastersId");

                    b.HasIndex("EFDungeonMastersId");
            ...
            modelBuilder.Entity("ApplicationUserCampaign1", b =>
                {
                    b.Property<string>("EFPlayersId")
                        .HasColumnType("text");

                    b.Property<int>("PlayerCampaignsId")
                        .HasColumnType("integer");

                    b.HasKey("EFPlayersId", "PlayerCampaignsId");

                    b.HasIndex("PlayerCampaignsId");
            ...
            modelBuilder.Entity("CharacterAccess", b =>
                {
                    ...
                    b.Property<string>("EFUserAccessId")
                        .HasColumnType("text");

                    b.HasKey("CharacterAccessId", "EFUserAccessId");

                    b.HasIndex("EFUserAccessId");
            ...
            modelBuilder.Entity("SADnD.Shared.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SADnD.Shared.Models.AppointmentVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SADnD.Shared.Models.Character", b =>
                {
                    ...
                    b.Property<List<bool>>("DeathRoles")
                        .HasColumnType("boolean[]");
            ...
            modelBuilder.Entity("ApplicationUserCampaign", b =>
                {
                    ...
                    b.HasOne("SADnD.Shared.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("EFDungeonMastersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SADnD.Shared.Models.AppointmentVote", b =>
                {
                    b.HasOne("SADnD.Shared.Models.Appointment", "Appointment")
                        .WithMany("AppointmentVotes")
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SADnD.Shared.Models.ApplicationUser", "AppUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
