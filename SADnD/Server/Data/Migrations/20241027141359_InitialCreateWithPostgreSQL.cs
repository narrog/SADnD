    ...
    public partial class InitialCreateWithPostgreSQL : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DungeonMasterCampaignsId = table.Column<string>(type: "text", nullable: false),
                    DungeonMastersId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignDungeonMasters", x => new { x.DungeonMasterCampaignsId, x.DungeonMastersId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignDungeonMasters_Campaigns_DungeonMasterCampaignsId",
                        column: x => x.DungeonMasterCampaignsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlayerCampaignsId = table.Column<string>(type: "text", nullable: false),
                    PlayersId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignPlayers", x => new { x.PlayerCampaignsId, x.PlayersId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignPlayers_Campaigns_PlayerCampaignsId",
